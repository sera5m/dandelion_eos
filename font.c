...
//okay, so i'm assuming this uses the standard types of 255 chars. uint 255 stores most original chars. 
//so the parser will translate uint8 to this. i'll make a function overload

//i'll have this reachable by the graphics system and put the print in there. which will be essentially "take chars, grab char memory from lut, and put it on screen"
